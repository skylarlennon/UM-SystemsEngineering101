...
2. Start at the [Part 1 README](1_Concept_&_Requirements/README1.md) and progress in order 
4. Pick **one case study** (A or B) and stick with it across all parts.
...
The libs are trying to turn the HIMalayas into the THEY/THEMALAYAS
